        ...
        <div className='mb-[94px]'>
            <div className='lg:grid lg:grid-cols-3 lg:gap-x-[10px] xl:gap-x-0 '>
             ...
             <picture> <img src='https://nexcent-react.vercel.app/assets/column_1-187b4bc8.png' alt="" /></picture>
              ...
              <div className='flex flex-col items-center'>
             <picture> <img src='https://nexcent-react.vercel.app/assets/column_2-0a78d2ca.png' alt="" /></picture>
                <div className="bg-[#F5F7FA] rounded lg:p-[16px] p-[25px] max-w-[317px] text-center translate-y-[-70px] shadow-lg ">
              ...
              <div className='flex flex-col items-center'>
             <picture> <img src='https://nexcent-react.vercel.app/assets/column_3-091802ce.png' alt="" /></picture>
                <div className="bg-[#F5F7FA] rounded lg:p-[16px] p-[25px] max-w-[317px] text-center translate-y-[-70px] shadow-lg ">
