...
const Suscipit = () => {
  return (
    <div className="bg-[#F5F7FA] py-[32px] dark:bg-dark">
        <div className="container">
            <h3 className='lg:max-w-[887px] md:max-w-[640px] max-w-[420px] m-auto text-center lg:text-[64px] text-[35px] md:text-[50px] font-semibold font-Inter lg:leading-[76px] mb-[32px] dark:text-white'>Pellentesque suscipit fringilla libero eu.</h3>
